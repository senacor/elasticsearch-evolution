package com.senacor.elasticsearch.evolution.testspringboot2.esresthighlevelclient790;
...
public class ApplicationTests {
    ...
    static class Config {
        ...
        public ElasticsearchContainer elasticsearchContainer() {
            ElasticsearchContainer container = new ElasticsearchContainer("docker.elastic.co/elasticsearch/elasticsearch-oss:7.9.0")
