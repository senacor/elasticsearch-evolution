package com.senacor.elasticsearch.evolution.rest.abstraction.rest5client;
...
public class EvolutionESRest5Client implements EvolutionRestClient<Rest5Client> {
    ...
    @Override
    public Rest5Client getUnderlyingClient() {
        return restClient;
    }
}
