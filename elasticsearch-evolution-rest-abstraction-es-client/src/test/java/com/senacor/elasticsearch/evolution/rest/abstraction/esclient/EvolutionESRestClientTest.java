package com.senacor.elasticsearch.evolution.rest.abstraction.esclient;
...
class EvolutionESRestClientTest {

    @Mock
    private RestClient restClient;

    private EvolutionESRestClient underTest;

    @BeforeEach
    void setUp() {
        underTest = new EvolutionESRestClient(restClient);
    }
    ...
    @Test
    void getUnderlyingClient_should_returnTheInternalRestClient() {
