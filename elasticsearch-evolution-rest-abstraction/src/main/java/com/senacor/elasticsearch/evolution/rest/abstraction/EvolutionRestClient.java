...
/**
 * Abstraction of a REST client for Elasticsearch / OpenSearch.
 *
 * @param <T> The used underlying client type
 */
public interface EvolutionRestClient<T> {
    ...
    /**
     * @return the underlying client used for creating requests
     */
