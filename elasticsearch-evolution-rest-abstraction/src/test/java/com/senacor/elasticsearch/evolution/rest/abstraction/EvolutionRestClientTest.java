...
class EvolutionRestClientTest {
    ...
    private final EvolutionRestClient<?> underTest = new EvolutionRestClient<>() {
        @Override
        public EvolutionRestResponse execute(@NonNull HttpMethod method, @NonNull String endpoint, Map<String, String> headers, Map<String, String> urlParams, String body) throws IOException {
