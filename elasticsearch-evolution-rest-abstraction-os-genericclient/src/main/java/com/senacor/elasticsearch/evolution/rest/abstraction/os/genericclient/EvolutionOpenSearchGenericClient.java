...
public class EvolutionOpenSearchGenericClient implements EvolutionRestClient<OpenSearchGenericClient> {
    ...
    @Override
    public OpenSearchGenericClient getUnderlyingClient() {
        return openSearchGenericClient;
    }
}
